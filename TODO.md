...
* Update types to account for the changes made above in the quarkus-cli-image-labelr
...
* Dispaly the thumbnails in the gallery rather than loading the complete images
